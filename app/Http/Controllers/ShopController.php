...
class ShopController extends Controller
{
    ...
    */
    ...
    {        $shopcategories = ShopCategory::orderBy('sort', 'DESC')->get();
            $shops = count($shopcategories) ? Shop::where('is_active', 1)->orderByRaw('FIELD(shop_category_id,'.implode(',', $shopcategories->pluck('id')->toArray()).')')->orderBy('id')->get()->groupBy('shop_category_id') : Shop::where('is_active', 1)->orderBy('id')->get()->groupBy('shop_category_id');
