...
@endif
<h1>
    <img src="/images/avatars/{{ $user->avatar }}" style="width:125px; height:125px; float:left; border-radius:25%; margin-right:25px;" alt="{{ $user->name }}" >
    {!! $user->displayName !!}
    {!! $user->isOnline() !!}
...
<div class="card-deck mb-4 profile-assets" style="clear:both;">
    <div class="card profile-currencies profile-assets-card">
        <div class="card-body text-center">
            ...
            <div class="profile-assets-content align-items-center d-flex justify-content-center">
